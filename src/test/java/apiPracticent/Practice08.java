...
public class Practice08 extends TestBase{
	...
	*/
	...
	public void postPractice() {
		...
		softAssert.assertEquals(actualDataObjMap.get("longitude").toString(), postReqBody.get("longitude").toString());
		softAssert.assertEquals(actualDataObjMap.get("altitude"), postReqBody.get("altitude"));
	//	softAssert.assertEquals(expectedData.get("rank"), postReqBody.get("rank"));
	//	softAssert.assertEquals(actualDataObjMap.get("source_type"), postReqBody.get("source_type"));
